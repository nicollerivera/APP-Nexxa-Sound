...
export const IconPayroll = ({ size = 14 }) => (
...
export const IconStaff = ({ size = 12 }) => (
...
export const IconInventory = ({ size = 14 }) => (
...
export const IconChecklist = ({ size = 14 }) => (
...
export const IconLogoNexxa = ({ size = 24 }) => (
...
export const IconIndicator = ({ size = 12 }) => (
